...
‪
    ...
    <body>
        ...
        $yey = "insert into sales(sdate,productname,model,description,salestype,customername,qtyout,unitprice,unitcost,paid,discount,staffname,recno)values(curdate(),'$product', '$product', '$dsc','$stype',  '$customer', '$qty','$uprice', '$cost', '$paid','$disk', '$user', '$recno')";
 ...
 $tata = "select productname,sum(qtyout) as qty,unitprice,sum(qtyout*unitprice)-sum(qtyout * unitprice * 0.01 * discount) as amount from sales where recno = '$recno' And qtyout > 0 group by productname";
 ...
 $ext = $sid['extended'];
  ...
  <li class = "ick">globalokeson@yahoo.com</li>
        ...
        <table class="table table-responsive table-bordered">
            <tr>
                <td id="may">Date</td>                      
                <td id="maya"><?php echo $today; ?></td>
                
            </tr>
            <tr>
                <td id="mos">Receipt#</td>
                <td id="ma"><?php echo $recno; ?></td>
            </tr>
            
            <tr>
                <td id="mx">Invoiced By</td>
                <td id="my"><?php echo $user; ?></td>
            </tr>
            
   <tr>
       <td id="ya">Bill To.</td>
       <td id="yaya"><?php echo $customer; ?></td>
            </tr>
