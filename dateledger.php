            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="button" id="pozer" class="btn btn-primary btn-lg" value="Search">
                    </div>
                    
                </div>
                <div id="klop" class="col-md-6">
