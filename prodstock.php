...
$result = $db_handle->executeUpdate("UPDATE products set " . $_POST["column"] . " = '".$_POST["editval"]."' WHERE  itid=".$_POST["id"]);
$result = $db_handle->executeUpdate("UPDATE stock set " . $_POST["column"] . " = '".$_POST["editval"]."' WHERE  itid=".$_POST["id"]);
