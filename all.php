...
$wela = "select username,password,status,location from users where username = '$user'";
	...
	//}
        ...
        $setx = "insert into sales(sdate,salestype,productname,customername,opbal,deposit,paid,others,discount,pdisc,phyrec,details,recno)values(curdate(),'payments','payments','$customer',0,'$dep','$bpmt','$others',0,0,'$recpt','$det','$rec')";
        ...
        $rew = mysql_query($setx) or die('cant insert into sales');
