...
‪<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
    ...
    <body>
        ...
        $dex = "select customername, productname,sum(qtyout) as qty,sum(qtyout * unitprice) as amount from sales where  year(sdate) = '$yr' group by productname";
        $tara = "select  sum(qtyout) as qtysold,sum(qtyout*unitprice) as sales,sum(paid) as payment,sum(deposit) as deposits,sum(others) as others from sales where  year(sdate) = '$yr'";
