...
$wela = "select username,password,status,location from users where username = '$user'";
    ...
    <body>
        ...
        $ref = "select model as productname,dept,rate,unitcost,stockbal,rate * stockbal as stockworth,unitcost * stockbal as stockcost,rate * stockbal - unitcost * stockbal as profit from stock where productname != 'payments'  group by productname";
        $res = mysql_query($ref);
