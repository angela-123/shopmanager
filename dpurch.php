...
‪<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
    ...
    <body>
        ...
        $dex = "select pdate,suppliername,productname,qtyin,unitcost,qtyin * unitcost as amount,paid,deposit,others  from purchases where pdate = '$date'";
        $tara = "select pdate, sum(qtyin) as qtysold,sum(qtyin*unitcost) as sales,sum(paid) as payment,sum(deposit) as deposits,sum(others) as others from purchases where pdate = '$date' group by pdate";
