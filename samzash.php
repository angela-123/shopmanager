...
‪
    ...
    <body>
        ...
        $ox = "select productname,location,stockbal from stock where productname = '$product' and location = '$loc'";
        ...
        $rans = "insert into trans(transdate,productname,location,qtyin,qtyout,opstock,recno)values('$today', '$product',  '$loc',0.0,'$qty',0.0,'$recno')";
 ...
 echo '<thead>';
 echo '<tr>';
 echo  '<h4 align = "center">MAGNELLI TELECOM </h4>';
 echo  '<h5 align = "center"> Wuse 2</h5>';
...
echo '<h5 align = "center">.....Magnelli Telecom </h5>';
