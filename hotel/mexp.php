...
<html>
    ...
    <body>
        ...
        $jon = mysql_connect('localhost','staff','angela')or die('cant connect');
         ...
         $zaq = "select costcenter,sum(amount) as amount from expenses where  monthname(date) = '$date' and year(date) ='$yr' group by costcenter";
         $taq = "select SUM(amount) as Amount from expenses where monthname(date) = '$date' and year(date) ='$yr'";
