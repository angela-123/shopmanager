...
<html>
    ...
    <body>
        <?php
         ...
         $nala = $tuf['balance'];
         //echo 'Balances'.$nala;
         $jag = "update rooms set payment = payment + $amt,balance = $nala - $amt where roomno = '$room'";
         mysql_query($jag) or die('cant update rooms');
          ...
          $exd = "insert into bills(date,cashier,customer,date1,date2,room,paid,bpmt)values('$date','$cashier','$gname','$checkin','$checkout',  '$room',0,'$amt')";
