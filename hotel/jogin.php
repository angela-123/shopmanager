    ...
    <body>
        ...
        <div id="fex" class="row">
            <div class="col-md-4 col-md-offset-3">
                <img src="images/sam.jpg" height="200" width="800" class="img img-responsive img-rounded">
                
            </div>
            
            <div id="midd" class="form-group col-md-4 col-md-offset-3" >
                
                <label class="form-control" style=" text-align:  center; color:  #000099; font-size: 1.2em; background: white;">LOGIN PAGE</label>
