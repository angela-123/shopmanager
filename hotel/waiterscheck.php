            ...
            $(document).ready(function(){
                ...
                $("#btn").click(function(){
                    ...
                    $.ajax({
                        ...
                        type:"post",
                        url:"waiters.php",
                        data:"date="+date+"&loc="+loc+"&waiter="+waiter,
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div id="nilid" title="ENTER DATE AND LOCATION " class="form-group">
                        ...
                        <label class="form-control" style=" background:  #bfbfbf;">Section</label><br>
                        <input type="text" id="loc" class="form-control" value="Bar"><br>
                        <label class="form-control">Waiter</label>
                        <input type="text" id="waiter" class="form-control" placeholder="waiter name">
