...
‪
    ...
    <body>
        ...
        $yey = "insert into sales(sdate,productname,model,sno,description,salestype,customername,qtyout,unitprice,unitcost,paid,discount,staffname,naira,recno)values(curdate(),'$product', '$px','$sno',  '$dsc','$stype',  '$customer', '$qty','$rate', '$cost', '$paid','$disk', '$user', '$naira', '$recno')";
 ...
 $tata = "select model as productname,sum(qtyout) as qty,unitprice,sum(qtyout*unitprice)-sum(qtyout * unitprice * 0.01 * discount) as amount from sales where recno = '$recno' group by productname";
