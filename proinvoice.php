...
<html>
    ...
    <body>
        ...
        $recno = $_POST['invoice'];
        $cname = $_POST['cname'];
  $tata = "select productname,sum(qtyout) as qty,unitprice, discount,sum(qtyout*unitprice)-sum(qtyout * unitprice * 0.01 * discount) as amount from sales where recno = '$recno' and productname!='' group by productname";
 
 $sisi = "select sdate, productname,sum(qtyout * unitprice * 0.01 * discount) as discount from sales where recno = '$recno' group by recno";
 ...
 //echo '<div class = "pull-left">';                                                                                     
                ...
                echo '<li clsas = "lag">EJHIL NIGERIA LTD.</li>';
                echo '<li>Liquor Center,Manufactures Representatives,Merchandising,Suppliers And General Contractors</li>';
                //echo '<li class = "lag">Head Office</li>';
                echo '<div class = "clearfix">';
                echo '<div class = "pull-left">';
                echo '<li class = "lag">Head Office</li>';
                echo '<li>SHOP LS,1194 ZUBA INTERNATIONAL MKT.</li>';
                echo '<li>P.O.BOX 218,Gwagwalada Area Council</li>';
