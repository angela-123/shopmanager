...
<html>
    ...
    <body>
        ...
        $rak = "insert into stock(productname,model,description,dept,rate,unitcost,stockbal,dealer)values('$pcode','$model','$xc', '$dep','$rate','$ucost','$opstock','$del')";
        $stock = "insert into products(productname,model,description,dept,rate,unitcost,dealer)values('$pcode','$model','$xc','$dept','$rate','$ucost','$del')";
        $sales = "insert into trans(transdate,productname,model,description,qtyin,qtyout,opstock)values(curdate(),'$pcode','$model','$xc',0.0,0.0,'$opstock')";
        $dstock = "insert into dstock(stdate,productname,model,description,qtyin,qtyout,stock)values(curdate(),'$pcode','$model','$xc'  ,0.0,0.0,'$opstock')";
