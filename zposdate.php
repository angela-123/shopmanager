...
‪<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
    ...
    <body>
        ...
        $yey = "insert into sales(sdate,customername,productname,qtyout,unitprice,paid,deposit,other,recno)values('$date','$customer','$product','$qty','$rate','$paid','$dep','$other','$recno')";
