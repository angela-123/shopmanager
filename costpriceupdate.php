            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <label class="form-control" style=" background:  #c7ddef;">New Cost Price</label>
                        <input type="number" id="price" class="form-control">
                        <button id="btx" class="btn btn-primary btn-lg">Preview Current Cost Price</button><button id="update" class="btn btn-primary btn-lg">Update Price</button><button id="prices" class="btn btn-primary btn-lg">View All Prices</button>
