        ...
        <div class="container-fluid">
            ...
            <div class="row" style="">
                ...
                <div class="form-group">
                    <label class="form-control" style=" text-align: center;color: darkred;font-size: 1.5em; background: #149bdf;">AUTHENTICATION</label>
                    ...
                    <input type="button" class="btn btn-primary btn-lg" value="Login" id="save">
