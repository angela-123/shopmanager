...
‪<link rel="stylesheet" href="css/bootstrap-theme.min.css">
  ...
  $gaga = "select * from  stock where productname !='' ";
 ...
 $rada = mysql_query($gaga);
        ...
        ?>
                <div class=" container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            <h4 class = "col-md-7 col-md-offset-7">STOCK REPORT</h4>
        <table class="table table-responsive table-striped table-hover table-bordered col-md-8 col-md-offset-4">
