...
‪
    ...
    <body>
        ...
        $set = "select sdate as date,productname,recno as invoiceno,qtyout,unitprice, qtyout * unitprice as debit,paid as credit,deposit,others as expenses,phyrec,details, 0.01 * qtyout * unitprice * discount as discount, 0.01 * qtyout * unitprice * pdisc as prdisc,opbal from sales where customername = '$pnamex'";
